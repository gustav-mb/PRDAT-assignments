...
type instr =
  ...
  | BREAK                              (* Break                           *) // Opgave 4
  | WAITFORKEYPRESS                    (* Wait for key press              *) // Opgave 4
...
let CODELDARGS = 24
let CODESTOP   = 25;
let CODEBREAK  = 26; // Opgave 4
let CODEWAITFORKEYPRESS = 27; // Opgave 4

(* Bytecode emission, second pass: emit code to file *)
...
let makelabenv (addr, labenv) instr = 
    ...
    | STOP           -> (addr+1, labenv)
    | BREAK          -> (addr+1, labenv) // Opgave 4
    | WAITFORKEYPRESS-> (addr+1, labenv) // Opgave 4
...
let rec emitints getlab instr ints = 
    ...
    | STOP           -> CODESTOP   :: ints
    | BREAK          -> CODEBREAK  :: ints // Opgave 4
    | WAITFORKEYPRESS -> CODEWAITFORKEYPRESS :: ints // Opgave 4
