...
type value = 
  ...
  | RecordV of (string * value) list // Opgave 3.2
...
let rec eval (e : expr) (env : value env) : value =
    ...
    // Opgave 3.2
    | Record xs -> RecordV (List.map (fun (x, e) -> (x, eval e env)) xs)
    | Field (e,s) -> 
      match eval e env with
      | RecordV xs -> lookup xs s
...
//HigherFun
let opg2_1 = Let ("x",Record [],Var "x");;
let opg2_2 = Let ("x",Record [("field1", CstI 32)],Field (Var "x","field1"));;
let opg2_3 = Let ("x",Record [("field1", CstI 32); ("field2", CstI 33)],Var "x");;
let opg2_4 = Let ("x",Record [("field1", CstI 32); ("field2", CstI 33)], Field (Var "x","field1"));;
let opg2_5 = Let ("x",Record [("field1", CstI 32); ("field2", CstI 33)], Prim ("+",Field (Var "x","field1"),Field (Var "x","field2")));;


// Opgave 3.3
// ParseAndRunHigher.run (Let ("x",Record [("field1", CstI 32)], Field (Var "x","field1")));;
// ParseAndRunHigher.run (Let ("x",Record [("field1", CstI 32); ("field2", CstI 33)], Field (Var "x","field1")));;
// ParseAndRunHigher.run (Let ("x",Record [("field1", CstI 32); ("field2", CstI 33)], Field (Var "x","field2")));;
// ParseAndRunHigher.run (Let ("x",Record [("field1", CstI 32); ("field2", CstI 33)], Prim ("+",Field (Var "x","field1"),Field (Var "x","field2"))));;
// ParseAndRunHigher.run (Let ("x",Record [("field1", CstI 32); ("field2", CstI 33)], Prim ("*",Field (Var "x","field1"),Field (Var "x","field2"))));;
