...
let makelabenv (addr, labenv) instr = 
    ...
    | STOP           -> (addr+1, labenv)
    // Opgave 4.3
    | PRINTCURFRM env -> (* Exam *)
      let len (i,s1:string) = 2 + s1.Length 
...
let rec emitints getlab instr ints = 
    ...
    | PRINTCURFRM env ->
      ...
      CODEPRINTCURFRM :: List.length env :: (List.foldBack codeVar env ints)
  //     printcurfrm         n                o, amount of chars, chars
